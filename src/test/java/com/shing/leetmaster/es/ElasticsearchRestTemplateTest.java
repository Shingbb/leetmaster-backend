...
import static co.elastic.clients.elasticsearch._types.query_dsl.Like.Kind.Document;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * ElasticsearchRestTemplate 测试
 *
 * @author Shing
 */
public class ElasticsearchRestTemplateTest extends TestBase {
    ...
    public void updateDocument() {
        ...
        // Convert the map into JSON-like string
        org.springframework.data.elasticsearch.core.document.Document updateDocument = org.springframework.data.elasticsearch.core.document.Document.from(updates);
        ...
        // Retrieve and assert updated document
